...
spec = extractNumber (info$, "Coefficient of independent variable Spec: ")
assert fixed$ (spec, 4) = "1.6587"   ; 'spec'
dur = extractNumber (info$, "Coefficient of independent variable Dur: ")
